...
<form id="add_ques" action="<?= base_url();?>question/add" method="post">
    <div class="row">
        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-group">
                                <input type="text" class="form-control" id="textImg" aria-describedby="basic-addon2">
                                <a id="pickfiles" class="input-group-addon iframe-btn" type="button" href="javascript:;"><i class="fa fa-plus"></i>  Chọn hình</a>
                            </div>
    ...
    <div class="row fixed_screen">
        <div style="text-align: center; padding: 10px 0 0">
            <button type="submit" name="save" class="btn btn-default">Add</button>
        </div>
    </div>
